            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="/kendaraan/update" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="mb-3">
                                    <label for="pemilik" class="form-label">Nama Pemilik</label>
                                    <input type="text" class="form-control" id="pemilik" name="pemilik" value=""
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="nopol" class="form-label">Nomer Plat Kendaraan</label>
                                    <input type="text" class="form-control" id="nopol" name="nopol" value="" required>
                                </div>
                                <label>Jenis Kendaraan</label>
                                <select id="jeniskendaraan" class="form-control" name="jeniskendaraan" value="">
